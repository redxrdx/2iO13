...
#    keytest.add("c",central)
    ...
    teama4 = SoccerTeam("test",[Player("t",millieu),Player("Defense",keytest)])
    teamPSG4 = SoccerTeam("team1",[Player("trapp",goalG),Player("silva",millieu),Player("aurier",defenseG),Player("zlatan",attaqueG)])
